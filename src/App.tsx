        ...
        {showSplash ? (
            ...
            <div className="max-w-none w-full flex flex-col items-center text-center">
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-slate-400 text-[11px] font-mono uppercase tracking-[0.3em]">VERSION 4.5.3</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="max-w-md w-full bg-white rounded-lg shadow-2xl p-8 relative">
              ...
              <div className="text-xs text-gray-400 text-center mt-6">Version 4.5.3 | 2026-04-26</div>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
